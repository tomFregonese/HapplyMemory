...
<template>
  <main>
    <div class="content">
      <CategoryItem v-for="category in categories" :key="category.id" @click.stop="selectCategory(category)"
                    :id="category.id" :title="category.title" :description="category.description" :revision="true"/>
    </div>
    <br>
    <div class="footer">
